...
"33%"}} alt="sax"></img>
<h1 style={{color: 'black', 'text-align': 'center', 'margin-bottom': '1em', 'margin-top': '0.5em', 'font-family' : 'Merienda'}}> Write songs faster.</h1>
...
<div className="textbox" style={{'font-family' : 'Ropa Sans'}}>Chordify will automatically place your chords right on top of the words. Songs can be written faster and look more organized. No one more
    ...
    <br />
<h4 style={{'font-family' : 'Merienda', 'background-color': '#37FDFC '}}>Space for your songs</h4>
